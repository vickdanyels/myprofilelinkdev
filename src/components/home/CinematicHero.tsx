...
const HYPERLIQUID_THEME = { primary: "148 249 227", accent: "21 181 164", background: "0 0 0" };
      ...
      ========================================= */}
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute inset-0 animate-cinematic-bg-phase-1 opacity-0">
                    <Image src="/home/iPhone%20Layers%20Home%20Panel/Background/BackgroundPurplePink.png" alt="Background" fill className="object-cover opacity-90 animate-slow-zoom" priority />
                </div>

                {/* Phase 2 (2-4s): Particles */}
                <div className="absolute inset-0 opacity-0 animate-cinematic-screen !transform-none" style={{ animationDelay: "2000ms" }}>
                    <LiveBackgrounds type="particles" enabled={true} themeColors={HYPERLIQUID_THEME} />
                </div>

                {/* Phase 3 (4-6s): Hyperliquid */}
                <div className="absolute inset-0 opacity-0 animate-cinematic-screen !transform-none" style={{ animationDelay: "4000ms" }}>
                    <LiveBackgrounds type="hyperliquid" enabled={true} themeColors={HYPERLIQUID_THEME} />
                </div>

                {/* Phase 4 (6-8s): Matrix */}
                <div className="absolute inset-0 opacity-0 animate-cinematic-screen !transform-none" style={{ animationDelay: "6000ms" }}>
                    <LiveBackgrounds type="matrix" enabled={true} themeColors={HYPERLIQUID_THEME} />
                </div>
                ...
                <div className="absolute inset-0 animate-cinematic-bg opacity-0" style={{ animationDelay: "8000ms" }}>
                    <Image src="/home/iPhone%20Layers%20Home%20Panel/Background/BackgroundPurplePink.png" alt="Background" fill className="object-cover opacity-90 animate-slow-zoom" />
                </div>

                {/* Overlay for depth - REMOVED */}
